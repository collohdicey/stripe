...
if(!empty($_POST['stripeToken'])){
    ...
    $stripe = array(
      "secret_key"      => "sk_test_SCVpMEsnMqXKUFaFzlQfMU5t00YWjnNHUh",
      "publishable_key" => "pk_test_erpq2dJboJPi1BBO3u8T0auz001NgoYLex"
    );    
    ...
    if($paymenyResponse['amount_refunded'] == 0 && empty($paymenyResponse['failure_code']) && $paymenyResponse['paid'] == 1 && $paymenyResponse['captured'] == 1){
       ...
       if($lastInsertId && $paymentStatus == 'succeeded'){
          ...
          $paymentMessage = "Payment failed3!";
       }
    } else{
        $paymentMessage = "Payment failed2!";
    }
} else{
    $paymentMessage = "Payment failed1!";
}
echo $paymentMessage;